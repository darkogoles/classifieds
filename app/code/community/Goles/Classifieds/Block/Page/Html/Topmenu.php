...
class Goles_Classifieds_Block_Page_Html_Topmenu extends Mage_Page_Block_Html_Topmenu {
    ...
    protected function _getHtml(Varien_Data_Tree_Node $menuTree, $childrenWrapClass) {
        ...
        foreach ($children as $child) {
            ...
            if ($child->hasChildren()) {
                $a_class = ' class="' . $outermostClass . ' dropdown-toggle" data-toggle="dropdown"';
                $carret = '<b class="caret"></b>';
            } else {
                $a_class = $outermostClassCode;
                $carret = '';
            }

            $html .= '<li ' . $this->_getRenderedMenuItemAttributes($child) . '>';
            $html .= '<a href="' . $child->getUrl() . '" ' . $a_class . '><span>'
                    . $this->escapeHtml($child->getName()) . '</span>' . $carret . '</a>';
